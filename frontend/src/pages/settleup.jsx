...
const SettleUpModal = ({ onClose, onConfirm, amount, recipient, isProcessing }) => {
    ...
    const handleConfirmSettlement = async () => {
        ...
        //   setIsProcessing(true);
          ...
          const response = await fetch(`${API_URL}/settle-up-payment/`, {
            method: 'POST',
            headers: {
          ...
          if (data.status === 'success') {
            ...
            setTimeout(() => {
              ...
              if (typeof onSuccess === 'function') {
                onSuccess(); // This would refresh the dashboard data
              }
            }, 2000);
          } else {
